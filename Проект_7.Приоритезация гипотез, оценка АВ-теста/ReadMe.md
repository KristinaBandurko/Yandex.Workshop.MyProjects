...
**pandas, matplotlib.pyplot, seaborn, scipy** <br/> приоритизация гипотез по фреймворкам ICE и RICE, анализ результатов А/В- теста, проверка статистических гипотез
